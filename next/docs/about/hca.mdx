...
To learn more about the HCA, visit [https://www.humancellatlas.org]({hcaOrg}).

To join the HCA community, you can register on this page: [https://www.humancellatlas.org/register]({hcaOrg}/register).
