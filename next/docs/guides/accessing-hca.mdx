...
title: "Requesting Access to Controlled HCA Data"
---

# Requesting Access to Controlled HCA Data
...
The HCA Data Access Committee (DAC) is an independent committee composed of international expertss, responsible for performing the review of applications for data access that third-party researchers submit, to obtain access to HCA-controlled access data.
...
The Datasets section of the Data Portal provides an interactive Data Explorer. Projects that you can access have the Access status Granted, while those requiring approval are marked
...
6. lick the **Apply for Access** button.
...
9. Once your access is granted, you can download the data directly or export it to Terra with the following steps.
   a. If you do not hear from the HCA DAC within two weeks, please contact HCA support at [data-help@humancellatlas.org](mailto:data-help@humancellatlas.org).

![Access Granted](/hca-bio-networks/guides/explorer-project-ag.png)

Link to other guides/subsections:
- [Exploring Projects](https://data.humancellatlas.org/guides)
- [Exporting HCA Data to Terra](https://data.humancellatlas.org/guides/consumer-vignettes/export-to-terra)
- [Exploring Project Matrices](https://data.humancellatlas.org/guides/consumer-vignettes/matrices)

To learn more about handing data off to Terra, [see this article](https://data.humancellatlas.org/guides/consumer-vignettes/export-to-terra).
