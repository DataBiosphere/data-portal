...
You can use the [HCA Data Explorer](https://explore.data.humancellatlas.org/projects) to find data to export to Terra. The Data Explorer lists projects with data available for download and lets you filter the data for a number of attributes.
