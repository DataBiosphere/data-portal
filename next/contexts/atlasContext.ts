...
import { AtlasModule, AtlasContext as AtlasContextType } from "../@types/network";

const DEFAULT_NETWORK = NETWORKS[0]

const DEFAULT_ATLAS = DEFAULT_NETWORK.atlases[0]

export const AtlasContext = createContext<AtlasContextType>({ network: DEFAULT_NETWORK, atlas: DEFAULT_ATLAS });
