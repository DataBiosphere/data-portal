...
The HNOCA extended includes 6 further datasets that have been recently published or released as a preprint. These datasets were mapped onto HNOCA with scArches, and include consensus cell type labels transferred from the HNOCA onto the mapped datasets.
