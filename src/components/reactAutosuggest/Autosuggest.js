 ...
 *
 * Autosuggest component, based on react-autosuggest (https://github.com/moroshko/react-autosuggest), with updated 
 * functionality to handle to show all results when there are no matches to the user input.
 * 
 * Requires shallow-equal, react-autowhatever and prop-types libraries.
 */
...
export default class Autosuggest extends Component {
    static propTypes = {
        ...
        suggestionsFound: PropTypes.bool,
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if ( !shallowEqualArrays(suggestions, prevProps.suggestions) &&
        ...
        if ( onSuggestionHighlighted ) {
            ...
            if ( highlightedSuggestion && highlightedSuggestion != prevHighlightedSuggestion ) {
                onSuggestionHighlighted({
