...
class TOCSpy extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        /* Rerun page anchors to get the latest content. */
        /* For metadata pages when "show only required fields" checkbox toggles content. */
        if ( prevProps.showAllMetadata === showAllMetadata ) {
    ...
    getPageAnchors = () => {
        ...
        this.elementIdsByAnchorFromTop = new Map();
