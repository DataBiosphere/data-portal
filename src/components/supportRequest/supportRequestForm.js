              ...
              <div className={classNames({ [compStyles.hidden]: submitted })}>
                ...
                {attachmentToken ? (
                  <div className={compStyles.inputAttachmentAttached}>
                    <div className={compStyles.inputAttachmentFileName}>
                      {attachmentName}
                    </div>
                    <button
                      className={compStyles.inputAttachmentDelete}
                  ...
                  >
                    {attachmentUploading ? (
                      ...
                      <div>
                        Drag or <span>click</span> to attach file.
                      </div>
                    )}
                  </button>
                )}
                ...
                <div className={compStyles.buttons}>
                  <button
                    className={classNames(
                      globalStyles.button,
                      compStyles.buttonCancel
                    )}
                    onClick={this.onSupportRequestDismissed}
                  >
                    Cancel
                  </button>
                  <button
