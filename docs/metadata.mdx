...
The lists of fields are currently being defined by members of the Biological Networks. Completed fields lists will appear below once finalized. The current list can be found in the [HCA Tier 2 Metadata Definitions](https://drive.google.com/drive/folders/1ngcIgKBV9OUM1pPO-CDRH6ZIpyiSpamu?usp=sharing) Google Drive folder.
