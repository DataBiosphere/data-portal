...
For datasets in the Managed-access Tier, access is granted through the Broad Institute’s Data Use Oversight System (DUOS). In the DUOS system, researchers can request access to a dataset and the DAC reviews and approves or denies the request.
...
4. **Sign in** again using your Google credentials to log into your Terra account on the DUOS website. This login will take you directly to the DUOS Human Cell Atlas Data Library.
...
9. Once your access is granted, you can download the data directly or [export it to Terra](/guides/consumer-vignettes/export-to-terra) with the following steps.
