...
### Release Highlights
In addition to the updates listed below, 137 projects have experienced updates in `data_use_restriction`, `bionetwork` and/or `atlas`. To view a list of which projects had these fields updated, please visit [this page](https://github.com/DataBiosphere/data-portal/issues/2593).
